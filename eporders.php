...
<div class="wrapper">
    ...
    <div class="main_content">
        ...
        <div class="info">
          <div class="topnav">
              <a href="custorders.php">Students</a>
              <a class="active" href="eporders.php">Employees</a>
</div>
...
<div class="container-fluid">
  <div class="card">
    <div class="card-body">
      ...
      $sql = "select * from eporders where status NOT IN ('Order Completed')";
      ...
      <tr>
        ...
        <td><?php echo $row['status']; ?></td>
          <td>
          <form method ="post" action = "eporders.php">
...
<?php
  ...
  if(isset($_POST['status'])){
    ...
    $sql      = "UPDATE eporders SET status = '$status' where id = '$id'";
