...
<div class="topnav">
  ...
  <a class="active" href="epfeedbacks.php">Feedbacks</a>
...
<table class="table table-bordered">
      ...
      $sql = "select * from eporders where username = '" . $_SESSION['username'] . "' AND status = 'Order Completed' AND feedback IS NULL";
      ...
      <tr>
        ...
        <td><a type="view" class="view" href="epaddfeedback.php?id=<?php echo $id; ?>">Feedback</a></td>
